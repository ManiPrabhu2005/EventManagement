...
<body>
    ...
    <nav>
        <ul>
            <li class="nav-left"><a href="home.php" class="prev-btn"><i class="fas fa-sign-out-alt"></i> Exit</a></li>
            <li class="nav-left"><a href="events.php" class="prev-btn"><i class="fas fa-tachometer-alt"></i> AdminDashboard</a></li>
