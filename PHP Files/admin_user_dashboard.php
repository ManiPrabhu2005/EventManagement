...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt = $conn->prepare($sql)) {
        ...
        if ($stmt->execute()) {
            ...
            echo "<script>
                    window.location.href = 'admin_user.php'; // Redirect to user_dashboard.php
                  </script>";
        } else {
...
<body>
    ...
    <nav class="navbar">
        ...
        <li class="nav-left"><a href="events.php" class="logout-btn"><i class="fas fa-tachometer-alt"></i> AdminDashboard</a></li>
    ...
    >
        ...
        <div class="preferences-container">
            ...
            <br><br>
            <label for="venues">
                <input type="checkbox" id="venues" name="preferences[]" value="VENUESBOOK">
                Venues
            </label>
            <label for="photographer">
                <input type="checkbox" id="photographer" name="preferences[]" value="PHOTOGRAPHERSBOOK">
                Photographer
            </label>
            <label for="caterer">
                <input type="checkbox" id="caterer" name="preferences[]" value="CATERERSBOOK">
                Caterer
            </label>
            <label for="music">
                <input type="checkbox" id="music" name="preferences[]" value="MUSICSBOOK">
                Music
            </label>
            <br><br>
